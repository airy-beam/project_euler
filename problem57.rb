...
numerator = 2
denominator = 1
#999 because first term 3 / 2 is not generated, this sequence starts with 7 / 5
999.times {
  numerator, denominator = denominator, numerator
  numerator += 2 * denominator
  final_numerator, final_denominator = denominator, numerator
  final_numerator += final_denominator
  if final_numerator.to_s.length > final_denominator.to_s.length then
    count += 1
  end
}
print count, "\n"
